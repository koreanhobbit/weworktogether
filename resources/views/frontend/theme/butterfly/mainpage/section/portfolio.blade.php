		...
		<div class="portfolio">
			...
			<div id="filters" class="sixteen columns">
				<ul class="clearfix">
					...
					@foreach($categories as $category)
						<li>
							<a class="" href="#" data-filter=".{{ $category->category->slug }}">
			...
			<div class="isotope" style="position: relative; overflow: hidden; height: 480px;" id="portfolio-wrap">
				@foreach($projects as $project)
					...
					<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-two {{ $project->category->slug }} isotope-item">
						<div class="portfolio-image"> <img src="{{ asset($project->images()->wherePivot('option', 1)->first()->medium->location) }}" title="{{ ucfirst($project->name) }}"> </div>
						<a title="{{ ucfirst($project->name) }}" data-toggle="modal" data-target="#modal-{{ $project->slug }}">
							<div class="project-overlay">
								<div class="project-info">
									<div class="zoom-icon"></div>
									<h4 class="project-name">{{ ucfirst($project->name) }}</h4>
									<p class="project-categories">{{ ucfirst($project->category->name) }}</p>
								</div>
							</div>
						</a>
					</div>
		...
		<div class="portfolio">
			...
			<div class="isotope" style="position: relative; overflow: hidden; height: 480px;" id="portfolio-wrap">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   videography isotope-item">
					<div class="portfolio-image"> <img src="{{  asset("frontend/butterfly/img/portfolio_pic1.jpg") }}" alt="Portfolio 1"> </div>
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
					<div class="portfolio-image"> <img src="{{  asset("frontend/butterfly/img/portfolio_pic2.jpg") }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design  isotope-item">
					<div class="portfolio-image"> <img src="{{  asset("frontend/butterfly/img/portfolio_pic3.jpg") }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  photography  branding web isotope-item">
					<div class="portfolio-image"> <img src="{{  asset("frontend/butterfly/img/portfolio_pic4.jpg") }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design isotope-item">
					<div class="portfolio-image"> <img src="{{  asset("frontend/butterfly/img/portfolio_pic5.jpg") }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(337px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  web isotope-item">
					<div class="portfolio-image"> <img src="{{  asset("frontend/butterfly/img/portfolio_pic6.jpg") }}" alt="Portfolio 1"> </div>
					<div class="project-overlay">
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(674px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four  design web isotope-item">
					<div class="portfolio-image"> <img src="{{  asset("frontend/butterfly/img/portfolio_pic7.jpg") }}" alt="Portfolio 1"> </div>
				...
				<div style="position: absolute; left: 0px; top: 0px; transform: translate3d(1011px, 240px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   photography isotope-item">
					<div class="portfolio-image"> <img src="{{  asset("frontend/butterfly/img/portfolio_pic8.jpg") }}" alt="Portfolio 1"> </div>
